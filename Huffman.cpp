...
int main()
{
    ...
    if (menuFlag == 1)
    {
        ...
        while (readbleFile.get(ch)) //подсчитываем частоту символов в while
        {
            ...
            if (ch == '\n') //в виндоус есть два специальных символа для переноса строки - это 13 и \n 
            {
                key = "cr";
            }
            else if (ch == 13) //в виндоус есть два специальных символа для переноса строки - это 13 и \n 
            {
                key = "cr";
            }
            else if (ch == ' ')
        ...
        frequencyOfSymbols["cr"] /= 2; //делю перенос строки на 2, т.к. на виндоус в файле для преноса строки используется два спецаильных символа
